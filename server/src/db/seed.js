...
async function seed() {
  ...
  const studentData = [
    ...
    { name: 'Prof. Fernanda Torres', email: 'fernanda@sinapse.com', enrollment: 'TCH004', role: 'teacher', avatar_url: 'https://i.pravatar.cc/150?img=25' },
    { name: 'Prof. Ricardo Moura',   email: 'ricardo@sinapse.com',  enrollment: 'TCH005', role: 'teacher', avatar_url: 'https://i.pravatar.cc/150?img=15' },
    { name: 'Prof. Vocês são mlks', email: 'prof1@sinapse.com', enrollment: 'TCH006', role: 'teacher', avatar_url: 'https://i.pravatar.cc/150?img=30' },
    { name: 'Prof. Molina', email: 'prof2@sinapse.com', enrollment: 'TCH007', role: 'teacher', avatar_url: 'https://i.pravatar.cc/150?img=35' },
    { name: 'Prof. Franscisco', email: 'prof3@sinapse.com', enrollment: 'TCH008', role: 'teacher', avatar_url: 'https://i.pravatar.cc/150?img=40' },
